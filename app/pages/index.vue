<template>
	<div class="min-h-screen bg-white dark:bg-[#0d0d0d] pb-20">
		<WeCareHeader />
		<WeCareSearchBar class="mb-4" />
		<WeCareCTACard class="mb-5" />
		<WeCareBannerCarousel :banners="banners" class="mb-5" />
		<WeCareTrendingSection :items="trendingItems" class="mb-5" />
		<WeCareProductSection title="Extra gifts" :tabs="giftTabs" :products="giftProducts" class="mb-5" />
		<WeCareProductSection title="Discover the bestsellers" :tabs="bestsellerTabs" :products="bestsellerProducts" class="mb-5" />
		<WeCareProductSection title="Discover the most desired brands" :tabs="brandTabs" :products="brandProducts" class="mb-5" />
		<WeCareProductSection title="Shop by need" :tabs="needTabs" :products="needProducts" class="mb-5" />

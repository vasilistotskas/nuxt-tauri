<template>
	<div class="min-h-screen bg-white dark:bg-[#0d0d0d] pb-24">
		...
		<header class="px-4 pt-14 pb-4">
			<h1 class="text-2xl font-bold text-black dark:text-white text-center tracking-wide">
				Cart
			</h1>
			<USeparator class="mt-4" :ui="{ border: 'border-[#e4e4e4] dark:border-[#282828]' }" />
		</header>
		...
		<section class="px-4 mt-8">
			<h2 class="text-lg font-bold text-black dark:text-white text-center tracking-wide mb-6">
				YOU MIGHT LIKE
			</h2>
			<UCarousel
				v-slot="{ item }"
				...
				dots
				:ui="{
					item: 'basis-[180px] shrink-0',
					dots: 'relative mt-4 bottom-0',
					dot: 'size-2.5 bg-[#d7d7d7] dark:bg-[#353535] data-[state=active]:bg-black dark:data-[state=active]:bg-white'
				}"
			>
		...
		<!-- Info Section -->
		<section class="px-4 mt-8 space-y-4">
			<USeparator :ui="{ border: 'border-[#d7d7d7] dark:border-[#353535]' }" />
			<p class="text-[15px] text-black dark:text-white tracking-wide">
